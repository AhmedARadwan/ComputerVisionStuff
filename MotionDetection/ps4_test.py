...
These test cases are here to help you design your code.
It is only here for reference. The result of these tests won't affect
your grade.

In addition, it is likely that these tests are "easier" than the autograder. The
goal is to get you started with these functions. You'll then need to adapt your
