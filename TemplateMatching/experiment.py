...
def compression_runner():
    ...
    img_compressed, compressed_frequency_img = ps2.compress_image_fft(
        img_bgr, keep)
    cv2.imwrite(OUTPUT_DIR + 'dog_compressed-0.001.jpg', img_compressed)
    cv2.imwrite(OUTPUT_DIR + 'dog_compressed_frequency-0.001.jpg',
...
def low_pass_filter_runner():
    ...
    cv2.imwrite(OUTPUT_DIR + 'cat_lpf-' + str(radius) + '.jpg', img_low_pass)
    cv2.imwrite(OUTPUT_DIR + 'cat_lpf_frequency-' + str(radius) + '.jpg',
